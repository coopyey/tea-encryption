...
void output_4096(char *out, char kind, char pass) {
    ...
    if ((kind == 'c') && (pass == '0')) {
        ...
        fp = fopen("cbc/tea_c_4096.txt", "w");
    } else if ((kind == 'p') && (pass == '2')) {
        fp = fopen("cbc/tea_p_4096.txt", "w");
    } else if ((kind == 'c') && (pass == '3')) {
        fp = fopen("ofb/tea_c_4096.txt", "w");
    } else if ((kind == 'p') && (pass == '3')) {
        fp = fopen("ofb/tea_p_4096.txt", "w");
    } 
...
void output_32768(char *out, char kind, char pass) {
    ...
    if ((kind == 'c') && (pass == '0')) {
        ...
        fp = fopen("cbc/tea_c_32768.txt", "w");
    } else if ((kind == 'p') && (pass == '2')) {
        fp = fopen("cbc/tea_p_32768.txt", "w");
    } else if ((kind == 'c') && (pass == '3')) {
        fp = fopen("ofb/tea_c_32768.txt", "w");
    } else if ((kind == 'p') && (pass == '3')) {
        fp = fopen("ofb/tea_p_32768.txt", "w");
    } 
